...
class Question extends GetView<Questioncontroller>{
  @override
  Widget build(BuildContext context) {
    ...
    return Directionality(
      ...
      child: Scaffold(
        appBar: AppBar(title: Text("اسأل الطبيب",style: TextStyle(color: Appcolors.secound_green,fontSize: 23.sp,fontWeight: FontWeight.bold)),centerTitle: true,),
        body: Container(
          ...
          child: Column(
            ...
            Container(
              ...
              children: [
                Text("اسأل الطبيب عن أي مشكلة لديك",textAlign: TextAlign.right,style: TextStyle(color: Colors.white,fontSize: 15.sp,fontWeight: FontWeight.bold)),
              Text("سيتم الرد عليك في أقرب وقت",textAlign: TextAlign.right,style: TextStyle(color: Colors.white60,fontSize: 13.sp,fontWeight: FontWeight.bold)),
            ],),
            ),
            SizedBox(height: 5.r,),
           ...
           Divider(),
            GetBuilder<Questioncontroller>(
                ...
                return Flexible(
                  child: Container(padding: EdgeInsets.all(7.r),width: 1.sw,height: 400.h,child: ListView(children: [
                    Row(
                      children: [
                        CircleAvatar(
                            backgroundImage:AssetImage("images/hasan.png"),radius: 20.r,),
                        BubbleSpecialThree(
                          text: 'مرحباُ كيف يمكنني مساعدتك',
             ...
             ?  controller.Question.isEmpty?null:Column(children: [...List.generate(controller.Question.length, (i){
